 ...
 */
export async function deviceAuthRateLimit(req: Request, res: Response, next: NextFunction): Promise<void> {
    ...
    try {
        ...
        if (minuteCount > 10) {
            ...
            res.status(429).json({
                error: 'slow_down',
                error_description: 'Too many device authorization requests. Please wait before trying again.',
            });
            return;
        }
 ...
 */
export async function deviceVerifyRateLimit(req: Request, res: Response, next: NextFunction): Promise<void> {
 ...
 */
export async function deviceConsentRateLimit(req: Request, res: Response, next: NextFunction): Promise<void> {
