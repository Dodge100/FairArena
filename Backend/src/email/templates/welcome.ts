...
<head>
  ...
  <title>Welcome to FairArena</title>
  <!--[if mso]>
  <noscript>
    <xml>
        ...
        <table role="presentation" class="container" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td align="center" style="padding: 32px 40px 24px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 8px 8px 0 0;">
              ...
              <h1 style="margin: 0; font-size: 28px; font-weight: 700; color: #ffffff; line-height: 1.3;">🎉 Welcome to FairArena!</h1>
            </td>
          </tr>
          <!-- Content -->
          <tr>
            <td class="content" style="padding: 40px;">
              ...
              <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #555555;">We're thrilled to have you join our community! Your account is ready, and you can start exploring everything FairArena has to offer.</p>
              <!-- CTA Button -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center" style="padding: 8px 0 32px;">
                    <a href="${dashboardUrl}" class="button" style="display: inline-block; padding: 16px 32px; background-color: #667eea; color: #ffffff; font-size: 16px; font-weight: 600; text-decoration: none; border-radius: 6px; box-shadow: 0 4px 12px rgba(102, 126, 234, 0.3);">Get Started</a>
                  </td>
                </tr>
              </table>
              <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.6; color: #555555;">Here's what you can do next:</p>
          ...
          <tr>
            <td style="padding: 24px 40px; background-color: #f9fafb; border-radius: 0 0 8px 8px; border-top: 1px solid #e5e7eb;">
              ...
              <p style="margin: 0; font-size: 12px; line-height: 1.5; color: #9ca3af; text-align: center;">You're receiving this email because you signed up for FairArena.</p>
            </td>
          </tr>
        </table>
      </td>
