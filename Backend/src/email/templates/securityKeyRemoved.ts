export const securityKeyRemovedTemplate = (params: {
  firstName: string;
  keyName: string;
  removedAt: string;
  securityUrl: string;
...
<head>
  ...
  <title>Security Key Removed</title>
  <style>
...
<body>
  <div class="container">
    <div class="header">
      ...
      <h1>Security Key Removed</h1>
    </div>
    <div class="content">
      <p>Hi <strong>${params.firstName}</strong>,</p>
      <p>A security key has been removed from your FairArena account.</p>

      <div class="alert-box">
        <p style="margin-bottom: 0;"><strong>Key Name:</strong> ${params.keyName}</p>
        <p style="margin-bottom: 0;"><strong>Time:</strong> ${params.removedAt}</p>
      </div>
