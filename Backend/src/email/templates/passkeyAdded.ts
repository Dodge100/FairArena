...
<body>
  <div class="container">
    <div class="header">
      ...
      <h1>New Passkey Added</h1>
    </div>
    <div class="content">
      <p>Hi <strong>${params.firstName}</strong>,</p>
      <p>A new passkey has been added to your FairArena account.</p>

      <div class="alert-box">
        <p style="margin-bottom: 0;"><strong>Passkey Name:</strong> ${params.passkeyName}</p>
      </div>

      <p>This passkey can now be used to sign in to your account without a password.</p>

      <p>If you did not add this passkey, please review your account security immediately.</p>
