                ...
                <div className="bg-white dark:bg-black rounded-xl p-8 max-w-md w-full border border-neutral-200 dark:border-neutral-800 shadow-sm">
                    <div className="flex flex-col items-center gap-6 text-center">
                        ...
                        <div className="space-y-2">
                            <h1 className="text-lg font-semibold text-neutral-900 dark:text-white">Authorization Error</h1>
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            <h2 className="text-xs font-semibold uppercase tracking-wider text-neutral-500">Requested Permissions</h2>
                        </div>
                            ...
                            {scopes.map((scope) => {
                                ...
                                return (
                                    <label
                                        ...
                                        `}
                                    >
                                        <div className={`mt-0.5 ${isSelected ? 'text-neutral-900 dark:text-white' : 'text-neutral-400'}`}>
                                            {getScopeIcon(scope)}
                                        </div>

                                        <div className="flex-1">
                                            <div className="flex items-center gap-2">
                                                <span className={`text-sm font-medium ${isSelected ? 'text-neutral-900 dark:text-white' : 'text-neutral-500'}`}>
                                                    {scope.displayName}
                                                </span>
                                                {scope.isDangerous && (
                                        ...
                                        <div className="relative flex items-center">
                                            ...
                                            `}>
                                                {isSelected && <CheckCircle2 className="w-3.5 h-3.5 text-white dark:text-black" />}
                                            </div>
                                        </div>
                                    </label>
                                );
                            ...
                            <div className="mt-4 p-4 rounded-xl bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-100 dark:border-neutral-800 space-y-3 animate-in fade-in slide-in-from-top-1">
                                <div className="grid grid-cols-2 gap-4 text-xs">
                                    ...
                                    <div>
                                        ...
                                        {application.websiteUrl ? (
                                            <a href={application.websiteUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 font-medium text-neutral-900 dark:text-neutral-200 hover:underline">
                                ...
                                <div className="pt-3 border-t border-neutral-200 dark:border-neutral-800 flex gap-4 text-xs text-neutral-500">
                                    {application.privacyPolicyUrl && (
                                        <a href={application.privacyPolicyUrl} target="_blank" rel="noopener noreferrer" className="hover:text-neutral-900 dark:hover:text-neutral-300 hover:underline">Privacy Policy</a>
                                    )}
                                    {application.termsOfServiceUrl && (
                                        <a href={application.termsOfServiceUrl} target="_blank" rel="noopener noreferrer" className="hover:text-neutral-900 dark:hover:text-neutral-300 hover:underline">Terms of Service</a>
                                    )}
                                </div>
                            </div>
                        )}
