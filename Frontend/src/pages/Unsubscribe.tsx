                    ...
                    <div className="text-center min-h-[120px] flex flex-col items-center justify-center">
                        ...
                        {status === 'success' && (
                            <div className="flex flex-col items-center space-y-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Successfully Unsubscribed</h3>
                        ...
                        {status === 'error' && (
                            <div className="flex flex-col items-center space-y-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Unsubscribe Failed</h3>
                                    <p className="text-gray-600 dark:text-gray-400">{message}</p>
                                </div>
                            </div>
                        )}
