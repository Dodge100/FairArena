  ...
  return (
    ...
    >
      <div className="max-w-4xl w-full leading-relaxed">
        ...
        <p className="mb-10">{t('termsAndConditions.intro')}</p>

        {/* ------------ SECTION 1 ------------ */}
        <LegalSection title={t('termsAndConditions.sections.definitions.title')} isDark={isDark}>
          <p className="mb-4">{t('termsAndConditions.sections.definitions.content')}</p>
          <LegalList
            items={
              t('termsAndConditions.sections.definitions.list', { returnObjects: true }) as string[]
            }
            isDark={isDark}
          />
        </LegalSection>
        ...
        <LegalSection title={t('termsAndConditions.sections.accounts.title')} isDark={isDark}>
          <p className="mb-4">{t('termsAndConditions.sections.accounts.content')}</p>
          <LegalList
            items={
              t('termsAndConditions.sections.accounts.list', { returnObjects: true }) as string[]
            }
            isDark={isDark}
          />
        </LegalSection>
        ...
        <LegalSection title={t('termsAndConditions.sections.usage.title')} isDark={isDark}>
          <LegalList
            items={t('termsAndConditions.sections.usage.list', { returnObjects: true }) as string[]}
            isDark={isDark}
          />
        </LegalSection>
        ...
        >
          <LegalList
            items={
              t('termsAndConditions.sections.intellectualProperty.list', {
                returnObjects: true,
              }) as string[]
            }
            isDark={isDark}
        ...
        <LegalSection title={t('termsAndConditions.sections.aiDisclaimer.title')} isDark={isDark}>
          <LegalList
            items={
              t('termsAndConditions.sections.aiDisclaimer.list', {
                returnObjects: true,
              }) as string[]
            }
            isDark={isDark}
        ...
        <LegalSection title={t('termsAndConditions.sections.links.title')} isDark={isDark}>
          <p>{t('termsAndConditions.sections.links.content')}</p>
        </LegalSection>
        ...
        <LegalSection title={t('termsAndConditions.sections.termination.title')} isDark={isDark}>
          <LegalList
            items={
              t('termsAndConditions.sections.termination.list', { returnObjects: true }) as string[]
            }
            isDark={isDark}
          />
        </LegalSection>
        ...
        <LegalSection title={t('termsAndConditions.sections.liability.title')} isDark={isDark}>
          <LegalList
            items={
              t('termsAndConditions.sections.liability.list', { returnObjects: true }) as string[]
            }
            isDark={isDark}
          />
        </LegalSection>
        ...
        <LegalSection title={t('termsAndConditions.sections.governing.title')} isDark={isDark}>
          <p>{t('termsAndConditions.sections.governing.content')}</p>
        </LegalSection>

        {/* ------------ SECTION 11 ------------ */}
        <LegalSection title={t('termsAndConditions.sections.disputes.title')} isDark={isDark}>
          <p>{t('termsAndConditions.sections.disputes.content')}</p>
        </LegalSection>
        ...
        <LegalSection title={t('termsAndConditions.sections.contact.title')} isDark={isDark}>
          <p>
            ...
            <a className="text-[#909d00]" href="mailto:legal@fairarena.app">
              legal@fairarena.app
            </a>
          </p>
        </LegalSection>
