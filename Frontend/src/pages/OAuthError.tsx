...
export default function OAuthError() {
    ...
    const getErrorInfo = (errorCode: string) => {
        ...
        return {
            title: title,
            description: errorDescription || t(`${baseKey}.description`, t('oauthError.defaultDescription')),
            solutions: t(`${baseKey}.solutions`, { returnObjects: true }) as string[] || [
                ...
                t('oauthError.errors.server_error.solutions.1', 'If the problem persists, contact FairArena support')
            ]
        };
    };
                    ...
                    <div className="p-8 space-y-6">
                        <div>
                            ...
                            <ul className="space-y-3">
                                {Array.isArray(errorInfo.solutions) && errorInfo.solutions.map((solution, index) => (
