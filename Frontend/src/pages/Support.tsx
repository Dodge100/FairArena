...
export default function Support() {
    ...
    return (
        <div className={`w-full px-4 py-12 relative overflow-hidden ${showFAQ ? 'flex flex-col' : 'min-h-screen flex flex-col items-center justify-center'}`}>
            {/* Spotlight Effects */}
            <Spotlight
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div
                    className={`absolute top-20 left-10 w-72 h-72 rounded-full blur-3xl opacity-20 animate-pulse ${isDark ? 'bg-[#DDEF00]' : 'bg-[#b5c800]'
                        }`}
                    style={{ animationDuration: '4s' }}
                />
                <div
                    className={`absolute bottom-20 right-10 w-96 h-96 rounded-full blur-3xl opacity-20 animate-pulse ${isDark ? 'bg-[#DDEF00]' : 'bg-[#b5c800]'
                        }`}
            ...
            `}
                    >
                        Have a question or need assistance? Our dedicated support team is here to help you succeed!
                    </p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                    {[
                        ...
                        { icon: MessageCircle, label: 'Support Tickets', value: '1000+', color: 'text-purple-500' },
              ...
              `}
                        ...
                        >
                            ...
                            <div className={`text-2xl font-bold mb-1 ${isDark ? 'text-neutral-100' : 'text-neutral-900'}`}>
                                {stat.value}
                            </div>
              ...
              `}
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-neutral-100' : 'text-neutral-900'}`}>
                                Email Support
                            </h3>
                            <p className={`text-sm mb-4 ${isDark ? 'text-neutral-400' : 'text-neutral-600'}`}>
                                fairarena.contact@gmail.com
                            </p>
                            <div className={`inline-flex items-center gap-2 text-sm font-medium ${isDark ? 'text-[#DDEF00]' : 'text-[#b5c800]'} group-hover:gap-3 transition-all duration-300`}>
                                Send Email
            ...
            `}
                        >
                            ...
                            <CardContent>
                                ...
                                <form className="pageclip-form space-y-5" method="POST" action={`https://send.pageclip.co/${import.meta.env.VITE_PAGECLIP_KEY}`}>
                                    {/* Name Field */}
                ...
                {showFAQ && (
                    <div ref={faqRef} className="mt-16 space-y-6">
                        <div className="text-center mb-8">
                            <h2 className={`text-3xl md:text-4xl font-bold mb-4 ${isDark ? 'text-neutral-100' : 'text-neutral-900'}`}>
                  ...
                  `}
                                >
                                    ...
                                    >
                                        ...
                                        {expandedFAQ === index ? (
                                            <ChevronUp className={`w-5 h-5 shrink-0 ${isDark ? 'text-[#DDEF00]' : 'text-[#b5c800]'}`} />
                                        ) : (
                                            <ChevronDown className={`w-5 h-5 shrink-0 ${isDark ? 'text-neutral-400' : 'text-neutral-600'}`} />
                                        )}
                                    </button>

                                    {expandedFAQ === index && (
                                        <div className={`px-5 pb-5 pt-0 ${isDark ? 'text-neutral-400' : 'text-neutral-600'}`}>
                                            {faq.answer}
                                        </div>
                                    )}
                                </div>
