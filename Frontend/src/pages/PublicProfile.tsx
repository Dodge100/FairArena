...
export default function PublicProfile() {
    ...
    const fullName = [profile.firstName, profile.lastName].filter(Boolean).join(' ') || 'Anonymous User';
                        ...
                        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-12">
                            ...
                            <div className="shrink-0">
                                <Avatar className="h-32 w-32 lg:h-48 lg:w-48 border-4 border-background shadow-2xl ring-4 ring-primary/10 transition-transform hover:scale-105">
                                    <AvatarImage
                                        src={profile.avatarUrl || `https://api.dicebear.com/7.x/initials/svg?seed=${fullName}`}
                                        alt={fullName}
                                    />
                            ...
                            <div className="flex-1 text-center lg:text-left space-y-6">
                                <div className="space-y-3">
                                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight">{fullName}</h1>
                                    {profile.jobTitle && (
                                        <p className="text-lg sm:text-xl text-muted-foreground flex flex-wrap items-center justify-center lg:justify-start gap-2">
                                            ...
                                            {profile.company && <span className="text-foreground/60">at {profile.company}</span>}
                                        </p>
                                    )}
                                    {profile.location && (
                ...
                <div className="max-w-screen-2xl mx-auto">
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                            ...
                            {profile.bio && (
                                <Card className="shadow-lg hover:shadow-xl transition-shadow border-0 bg-card/50 backdrop-blur-sm">
                                    ...
                                    <CardContent className="pt-0">
                                        <p className="text-muted-foreground text-base leading-relaxed whitespace-pre-wrap">{profile.bio}</p>
                                    </CardContent>
                                </Card>
                            )}
                                    ...
                                    <CardContent className="pt-0">
                                        <div className="flex flex-wrap gap-3">
                                            {profile.skills.map((skill) => (
                                                <Badge key={skill} variant="secondary" className="px-4 py-2 text-sm font-medium hover:bg-primary hover:text-primary-foreground transition-colors">
                                                    {skill}
                                                </Badge>
                                            ))}
                                        </div>
                                    ...
                                    <CardContent className="pt-0">
                                        <ul className="space-y-3">
                                            {profile.education.map((edu, index) => (
                                                <li key={index} className="text-muted-foreground text-base flex items-start gap-3">
                                        ...
                                        <CardContent className="pt-0">
                                            <div className="flex flex-wrap gap-2">
                                                {profile.languages.map((lang) => (
                                                    <Badge key={lang} variant="outline" className="px-3 py-1.5 hover:bg-accent transition-colors">
                                                        {lang}
                                                    </Badge>
                                                ))}
                                            </div>
                                        ...
                                        <CardContent className="pt-0">
                                            <div className="flex flex-wrap gap-2">
                                                {profile.interests.map((interest) => (
                                                    <Badge key={interest} variant="outline" className="px-3 py-1.5 hover:bg-accent transition-colors">
                                                        {interest}
                                                    </Badge>
                                                ))}
                                            </div>
                        ...
                        <div className="space-y-8">
                                ...
                                <Card className="shadow-lg hover:shadow-xl transition-shadow border-0 bg-card/50 backdrop-blur-sm">
                                    ...
                                    <CardContent className="pt-0">
                                        <div className="text-center py-6">
                                            <div className="text-4xl font-bold text-primary">{profile.yearsOfExperience}</div>
                            ...
                            {/* Links */}
                            {(profile.githubUsername || profile.twitterHandle || profile.linkedInProfile || profile.portfolioUrl || profile.resumeUrl) && (
                                <Card className="shadow-lg hover:shadow-xl transition-shadow border-0 bg-card/50 backdrop-blur-sm">
                                    <CardHeader className="pb-4">
            ...
            <Dialog open={showConsentDialog} onOpenChange={setShowConsentDialog}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            This profile collects information about visitors. By continuing, you allow the
                            profile owner to see your name and email address.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="py-4">
