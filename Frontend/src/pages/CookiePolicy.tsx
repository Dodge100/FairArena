        ...
        >
          ...
          `}
                ...
                <LegalSection title={t('cookiePolicy.sections.definitions.title')} isDark={isDark}>
                    <h3 className="text-xl font-semibold mb-2">{t('cookiePolicy.sections.definitions.subtitle1')}</h3>
                    <p className="mb-4">
                        {t('cookiePolicy.sections.definitions.content1')}
                    </p>
                    <h3 className="text-xl font-semibold mb-2">{t('cookiePolicy.sections.definitions.subtitle2')}</h3>
                    <LegalList
                        isDark={isDark}
                ...
                <LegalSection title={t('cookiePolicy.sections.usage.title')} isDark={isDark}>
                    <h3 className="text-xl font-semibold mb-2">{t('cookiePolicy.sections.usage.subtitle')}</h3>
                    <p className="mb-2">
                        {t('cookiePolicy.sections.usage.content1')}
                    </p>
                    <p className="mb-4">
                        {t('cookiePolicy.sections.usage.content2')}
                    </p>

                    <h4 className="text-lg font-semibold mb-2 mt-4 text-[#ddef00]">{t('cookiePolicy.sections.usage.types.essential.title')}</h4>
                    ...
                    <p className="mb-4">
                        {t('cookiePolicy.sections.usage.types.essential.purpose')}
                    </p>

                    <h4 className="text-lg font-semibold mb-2 mt-4 text-[#ddef00]">{t('cookiePolicy.sections.usage.types.functionality.title')}</h4>
                    ...
                    <p className="mb-4">
                        {t('cookiePolicy.sections.usage.types.functionality.purpose')}
                    </p>

                    <h4 className="text-lg font-semibold mb-2 mt-4 text-[#ddef00]">{t('cookiePolicy.sections.usage.types.tracking.title')}</h4>
                    ...
                    <p className="mb-4">
                        {t('cookiePolicy.sections.usage.types.tracking.purpose')}
                    </p>
                </LegalSection>
                ...
                <LegalSection title={t('cookiePolicy.sections.choices.title')} isDark={isDark}>
                    <p className="mb-4">
                        {t('cookiePolicy.sections.choices.content1')}
                    </p>
                    <p className="mb-4">
                        {t('cookiePolicy.sections.choices.content2')}
                    </p>
                    <p className="mb-4">
                        {t('cookiePolicy.sections.choices.content3')}
                    </p>
                </LegalSection>
                ...
                <LegalSection title={t('cookiePolicy.sections.moreInfo.title')} isDark={isDark}>
                    <p className="mb-4">
                        {t('cookiePolicy.sections.moreInfo.content')}
                    </p>
                </LegalSection>
