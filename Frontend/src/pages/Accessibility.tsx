    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="FairArena is committed to ensuring digital accessibility for people with disabilities. Learn about our accessibility features and standards." />
            </Helmet>
            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-900 text-white">
                <div className="max-w-5xl mx-auto px-6 py-20">
                    ...
                    <motion.section
                        ...
                        className="mb-16"
                    >
                        <h2 className="text-3xl font-bold mb-8 text-center">{t('accessibility.features.title')}</h2>
                    ...
                    >
                        ...
                        <ul className="space-y-3 text-gray-300">
                            {(t('accessibility.standards.list', { returnObjects: true }) as string[]).map((item, i) => (
