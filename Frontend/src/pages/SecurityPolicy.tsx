    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Learn about FairArena's security practices, data protection measures, and commitment to keeping your information safe." />
            </Helmet>
            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-900 text-white">
                <div className="max-w-5xl mx-auto px-6 py-20">
                    ...
                    <motion.section
                        ...
                        className="mb-16"
                    >
                        <h2 className="text-3xl font-bold mb-8 text-center">{t('securityPolicy.practices.title')}</h2>
                    ...
                    >
                        ...
                        <p className="text-gray-300 mb-6">
                            {t('securityPolicy.disclosure.text')}
                        </p>
                        <div className="bg-gray-900/50 rounded-lg p-6 space-y-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-green-400 mb-2">{t('securityPolicy.disclosure.pgp.label')}</h3>
                                <p className="text-gray-400 text-sm">{t('securityPolicy.disclosure.pgp.value')}</p>
                            </div>
                            <div>
                                <h3 className="font-semibold text-green-400 mb-2">{t('securityPolicy.disclosure.response.label')}</h3>
                                <p className="text-gray-400 text-sm">{t('securityPolicy.disclosure.response.value')}</p>
                            </div>
                        </div>
                    </motion.section>
                    ...
                    >
                        ...
                        <p className="text-gray-300 mb-4">
                            {t('securityPolicy.bounty.text')}
                        </p>
                        <ul className="space-y-2 text-gray-300 ml-6 mb-6">
                            {(t('securityPolicy.bounty.list', { returnObjects: true }) as string[]).map((item, i) => (
                    ...
                    >
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div>
                                <h3 className="text-xl font-semibold mb-3 text-green-400">{t('securityPolicy.compliance.standards.title')}</h3>
                                <ul className="space-y-2 text-gray-300">
                                    {(t('securityPolicy.compliance.standards.list', { returnObjects: true }) as string[]).map((item, i) => (
                                        <li key={i}>• {item}</li>
                                    ))}
                                </ul>
                            </div>
                            <div>
                                <h3 className="text-xl font-semibold mb-3 text-green-400">{t('securityPolicy.compliance.audits.title')}</h3>
                                <ul className="space-y-2 text-gray-300">
                                    {(t('securityPolicy.compliance.audits.list', { returnObjects: true }) as string[]).map((item, i) => (
                                        <li key={i}>• {item}</li>
                                    ))}
                                </ul>
                            </div>
