    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="FairArena's Digital Millennium Copyright Act (DMCA) policy and copyright infringement reporting procedures." />
            </Helmet>
                ...
                <div className="max-w-4xl mx-auto px-6 py-20">
                    ...
                    >
                        ...
                        <section className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                            ...
                            <p className="text-gray-300 mb-4">
                                {t('dmca.notification.text')}
                            </p>
                            <ul className="space-y-3 text-gray-300 ml-6">
                                {(t('dmca.notification.list', { returnObjects: true }) as string[]).map((item, i) => (
