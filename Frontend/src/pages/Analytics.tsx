...
const MOCK_ANALYTICS = {
    ...
    achievements: [
        { title: 'First Win', description: 'Won your first hackathon', date: '2024-03-15', icon: Trophy },
        { title: 'Team Player', description: 'Collaborated with 10+ teams', date: '2024-06-20', icon: Users },
        { title: 'Code Master', description: 'Submitted 20+ projects', date: '2024-09-10', icon: Code },
        { title: 'Rising Star', description: 'Reached 1000 profile views', date: '2024-11-05', icon: Star }
    ],
    recentActivity: [
        { type: 'submission', project: 'AI-Powered Code Review', hackathon: 'Global Tech Hackathon', date: '2 days ago', status: 'pending' },
        { type: 'win', project: 'Blockchain Voting System', hackathon: 'Web3 Challenge', date: '1 week ago', status: 'won', prize: '$5,000' },
        { type: 'collaboration', project: 'Smart Home Dashboard', team: 'Tech Innovators', date: '2 weeks ago', status: 'active' }
    ]
};
        ...
        <Card className="hover:shadow-lg transition-all duration-300 border-l-4" style={{ borderLeftColor: color }}>
            <CardContent className="p-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className={cn("p-3 rounded-full bg-opacity-10")} style={{ backgroundColor: `${color}20` }}>
                                            ...
                                            {MOCK_ANALYTICS.recentActivity.map((activity, index) => (
                                                ...
                                                >
                                                    <div className={cn(
                                                        ...
                                                        activity.type === 'win' ? 'bg-yellow-500/10 text-yellow-600' :
                                                            activity.type === 'submission' ? 'bg-blue-500/10 text-blue-600' :
                                                                'bg-purple-500/10 text-purple-600'
                                                    )}>
                                                        {activity.type === 'win' ? <Trophy className="w-4 h-4" /> :
                                                            activity.type === 'submission' ? <Target className="w-4 h-4" /> :
                                ...
                                <CardContent className="space-y-6">
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="font-bold">{MOCK_ANALYTICS.overview.teamCollaborations}</span>
                                        </div>
                                        <Separator />
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {Object.entries(MOCK_ANALYTICS.performance.winsByCategory).map(([category, wins]) => (
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    <div className="flex items-center justify-between p-3 rounded-lg bg-red-500/10">
                                        ...
                                        <span className="text-2xl font-bold">{MOCK_ANALYTICS.engagement.totalLikes}</span>
                                    </div>
                                    <div className="flex items-center justify-between p-3 rounded-lg bg-blue-500/10">
                                        ...
                                        <span className="text-2xl font-bold">{MOCK_ANALYTICS.engagement.totalComments}</span>
                                    </div>
                                    <div className="flex items-center justify-between p-3 rounded-lg bg-green-500/10">
                                        ...
                                        <span className="text-2xl font-bold">{MOCK_ANALYTICS.engagement.totalShares}</span>
                                    </div>
                                </CardContent>
                            </Card>
