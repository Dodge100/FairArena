...
import { AlertCircle, AlertTriangle, CheckCircle, Clock, Filter, Info, Loader2, Mail, Shield, XCircle } from 'lucide-react';
...
export default function AccountLogs() {
    ...
    const checkVerificationStatus = async () => {
        try {
            const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/v1/account-settings/status`, {
                credentials: 'include',
            });
    ...
    const sendOtp = async () => {
        ...
        setRetryAfter(0);
        try {
            const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/v1/account-settings/send-otp`, {
                method: 'POST',
                credentials: 'include',
            });
            const data = await res.json();
    ...
    const verifyOtp = async () => {
        ...
        setRetryAfter(0);
        try {
            const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/v1/account-settings/verify-otp`, {
                method: 'POST',
                headers: {
