        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-neutral-200 dark:border-neutral-800 pb-8">
          <div>
            ...
            <p className="text-neutral-500 dark:text-neutral-400 max-w-2xl">
              Create and manage OAuth applications to integrate securely with the FairArena
              platform.
            </p>
          </div>
          <button
              ...
              >
                <div className="p-6 flex-1">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <span
                            className={`inline-block w-2 h-2 rounded-full ${app.isActive ? 'bg-neutral-900 dark:bg-white' : 'bg-neutral-300 dark:bg-neutral-700'}`}
                          />
                        ...
                        <div className="mt-1">
                          ...
                          {app.verificationStatus === 'rejected' && (
                            <span
                              className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-[10px] font-medium rounded-full"
                              title={app.verificationRejectionReason || 'Verification rejected'}
                            >
                  ...
                  {app.description ? (
                    ...
                    <p className="text-sm text-neutral-400 italic mb-6 h-10 flex items-center">
                  ...
                  <div className="bg-neutral-50 dark:bg-neutral-900/50 rounded-lg p-3 border border-neutral-100 dark:border-neutral-800 mb-6 group-hover:bg-neutral-100 dark:group-hover:bg-neutral-900 transition-colors">
                    <span className="text-[10px] uppercase font-bold text-neutral-400 tracking-wider mb-1 block">
                      Client ID
                    </span>
                    <div className="flex items-center justify-between gap-2">
                      <code className="text-xs font-mono text-neutral-700 dark:text-neutral-300 truncate">
                        {app.clientId}
                      </code>
                      <button
    ...
    <div className="fixed inset-0 bg-neutral-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
      <div className="bg-white dark:bg-black rounded-2xl p-6 md:p-8 max-w-lg w-full border border-neutral-200 dark:border-neutral-800 shadow-xl max-h-[90vh] overflow-y-auto animate-in slide-in-from-bottom-4 duration-300">
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            onClick={onClose}
            className="p-1 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-900 text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500 mt-1">
                Displayed when users authorize your app
              </p>
            </div>
      ...
      <div className="bg-white dark:bg-black rounded-2xl p-6 max-w-sm w-full border border-neutral-200 dark:border-neutral-800 shadow-xl">
        <div className="flex flex-col items-center mb-6 text-center">
          ...
          <p className="text-sm text-neutral-500 mt-2">
            ...
            <strong className="text-neutral-900 dark:text-white">{appName}</strong>? This action
            cannot be undone.
          </p>
        </div>
      ...
      <div className="bg-white dark:bg-black rounded-2xl p-6 md:p-8 max-w-md w-full border border-neutral-200 dark:border-neutral-800 shadow-xl">
        <div className="mb-6">
          ...
          <p className="text-neutral-500 dark:text-neutral-400">
            Verify <span className="font-semibold text-neutral-900 dark:text-white">{appName}</span>{' '}
            to show a verified badge on the consent screen and increase user trust.
          </p>
          <div className="mt-4 p-3 bg-neutral-50 dark:bg-neutral-900 rounded-lg text-sm text-neutral-600 dark:text-neutral-400">
            <p>
              Our team will review your application logic, privacy policy, and terms of service.
