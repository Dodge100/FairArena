...
const OrganizationSettings = () => {
    ...
    useEffect(() => {
        const fetchOrganization = async () => {
            ...
            try {
                const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/v1/organization/${slug}`, {
                    headers: {
    ...
    const handleSave = async () => {
        ...
        setSaving(true);
        try {
            const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/v1/organization/${organization.slug}/settings`, {
                method: 'PUT',
                headers: {
    ...
    const handleDelete = async () => {
        ...
        try {
            const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/v1/organization/${organization.slug}`, {
                method: 'DELETE',
                headers: {
                    Authorization: `Bearer ${await getToken()}`,
                },
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => setFormData(prev => ({ ...prev, joinEnabled: checked }))}
                                disabled={!canEdit}
                            />
                        </div>
                    </CardContent>
                ...
                {canDelete && (
                    <Card className="border-red-200 dark:border-red-800">
                        ...
                        <CardContent>
                            <div className="flex items-center justify-between">
                                <div>
                                    <h4 className="font-medium text-red-600 dark:text-red-400">Delete Organization</h4>
                                    <p className="text-sm text-muted-foreground">
                                    ...
                                    <AlertDialogContent>
                                        <AlertDialogHeader>
                                            ...
                                            <AlertDialogDescription>
                                                ...
                                                "{organization.name}" and remove all associated data including teams, members,
                                                and settings.
                                            </AlertDialogDescription>
                                        </AlertDialogHeader>
                                        <AlertDialogFooter>
