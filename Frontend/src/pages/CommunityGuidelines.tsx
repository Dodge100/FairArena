    ...
    const guidelines = [
        {
            ...
            examples: t('communityGuidelines.core.items.respectful.examples', { returnObjects: true }) as string[]
        },
        {
            ...
            examples: t('communityGuidelines.core.items.collaborate.examples', { returnObjects: true }) as string[]
        },
        {
            icon: <Shield className="w-8 h-8" />,
            title: t('communityGuidelines.core.items.integrity.title'),
            description: t('communityGuidelines.core.items.integrity.desc'),
            examples: t('communityGuidelines.core.items.integrity.examples', { returnObjects: true }) as string[]
        },
        {
            ...
            examples: t('communityGuidelines.core.items.communicate.examples', { returnObjects: true }) as string[]
        }
    ];
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="FairArena's community guidelines for creating a safe, respectful, and collaborative environment for all users." />
            </Helmet>
                ...
                <div className="max-w-5xl mx-auto px-6 py-20">
                    ...
                    >
                        ...
                        <p className="text-gray-300 mb-4">
                            {t('communityGuidelines.commitment.text1')}
                        </p>
                        <p className="text-gray-300">
                            {t('communityGuidelines.commitment.text2')}
                        </p>
                    </motion.section>
                    ...
                    <motion.section
                        ...
                        className="mb-16"
                    >
                        <h2 className="text-3xl font-bold mb-8 text-center">{t('communityGuidelines.core.title')}</h2>
                    ...
                    >
                        ...
                        <p className="text-gray-300 mb-6">
                            {t('communityGuidelines.prohibited.text')}
                        </p>
                    ...
                    <motion.section
                        ...
                        className="mb-16 bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10"
                    >
                        <h2 className="text-3xl font-bold mb-4">{t('communityGuidelines.enforcement.title')}</h2>
                        <p className="text-gray-300 mb-4">
                            {t('communityGuidelines.enforcement.text')}
                        </p>
                        <ul className="space-y-3 text-gray-300 ml-6">
                            {(t('communityGuidelines.enforcement.items', { returnObjects: true }) as string[]).map((item, i) => (
                        ...
                        <p className="text-gray-300 mt-4">
                            {t('communityGuidelines.enforcement.note')}
                        </p>
                    </motion.section>
                    ...
                    >
                        ...
                        <p className="text-gray-300 mb-6">
                            {t('communityGuidelines.report.text')}
                        </p>
