  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        {/* Footer */}
        <div
          className={`px-6 py-4 border-t ${isDark ? 'border-neutral-800 bg-neutral-900/50' : 'border-neutral-100 bg-neutral-50/50'}`}
        >
          <div
          ...
          >
            ...
            <p>
              Open the FairArena app on your signed-in device and scan this code to sign in on this
              device.
            </p>
          </div>
        </div>
