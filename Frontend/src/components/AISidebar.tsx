...
import { Bot, Copy, Download, Loader2, MessageSquare, Mic, Moon, RotateCcw, Search, Send, Settings, Sparkles, Sun, ThumbsDown, ThumbsUp, Trash2, User, X, Zap } from 'lucide-react';
...
renderer.link = (href, title, text) => {
    ...
    const safeTitle = typeof title === 'string' && title && title !== 'undefined' ? title.replace(/undefined/g, '') : '';
            ...
            {isOpen && (
                <>
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="space-y-4 text-sm text-muted-foreground">
                                            <div>
                                                ...
                                                <p>
                                                    By using our AI assistant, you agree to use it responsibly and
                                                    ethically. The AI may provide inaccurate information, so please
                                            ...
                                            <div>
                                                ...
                                                <p>
                                                    Your conversations may be used to improve our AI services. We
                                                    collect usage data and feedback to enhance the experience. Personal
                                                    information is handled according to our main privacy policy.
                                                </p>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <p>
                                                    Messages are processed by our AI systems. We may retain
                                                    conversations for quality improvement and support purposes.
                                                </p>
                                            </div>
                                        </div>
                    ...
                    <motion.div
                        ...
                        style={{ width: window.innerWidth < 1024 ? '100%' : `${sidebarWidth}px`, maxWidth: window.innerWidth < 640 ? '100vw' : window.innerWidth < 768 ? '90vw' : window.innerWidth < 1024 ? '600px' : '800px' }}
                    >
                        {/* Resize Handle */}
                        <div
                        ...
                        {/* Messages */}
                        <div ref={messagesContainerRef} className="flex-1 overflow-y-auto px-2 sm:px-4 py-4 space-y-4 min-w-0 relative scroll-smooth">
                            {messages.length === 0 ? (
                                            ...
                                            {[
                                                ...
                                                >
                                                    <div className="w-8 h-8 rounded-lg bg-[#DDEF00]/10 flex items-center justify-center group-hover:bg-[#DDEF00]/20 transition-colors">
                                                        {React.createElement(suggestion.icon, { className: "w-4 h-4 text-[#DDEF00]" })}
                                                    </div>
                                                            ...
                                                            {message.role === 'assistant' && (
                                                                <div className="flex items-center gap-1">
                                                                    ...
                                                                    <motion.button
                                                                        ...
                                                                        className={`p-1.5 rounded-lg transition-colors ${aiSpeaking ? 'bg-[#DDEF00]/20 text-[#DDEF00]' : 'hover:bg-muted'
                                                                            }`}
