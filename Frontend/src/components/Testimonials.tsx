  ...
  return (
    <section className="py-24 relative w-full overflow-hidden bg-background">
      <div className="container mx-auto px-4 mb-16 text-center">
        ...
        >
          Don't just take our word for it. Here is what organizers and participants have to say per
          fair judging.
        </p>
      </div>
              ...
              (
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    />
                    <div>
                      <h4 className={cn('font-bold', isDark ? 'text-white' : 'text-black')}>
                        {t.name}
                      </h4>
                      <p
                        className={cn(
                  ...
                  <div className="flex gap-1 mb-3">
                    {[1, 2, 3, 4, 5].map((s) => (
                      <Star key={s} size={14} className="fill-[#d9ff00] text-[#d9ff00]" />
                    ))}
                  </div>
                  <p
                    className={cn(
