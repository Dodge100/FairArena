  ...
  return (
    <div className={className}>
      ...
      >
        ...
        <Upload
          className={`w-12 h-12 mx-auto mb-4 ${isDark ? 'text-neutral-400' : 'text-neutral-500'}`}
        />

        <p
          className={`text-lg font-medium mb-2 ${isDark ? 'text-neutral-200' : 'text-neutral-800'}`}
        >
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p
                    className={`text-sm font-medium truncate ${isDark ? 'text-neutral-200' : 'text-neutral-800'}`}
                  >
                    {fileData.file.name}
                  </p>
                  ...
                  {fileData.status === 'uploading' && (
                    <div className="mt-2">
                      <div
                        className={`h-1.5 rounded-full overflow-hidden ${isDark ? 'bg-neutral-800' : 'bg-neutral-200'}`}
                      >
                        <div
                      ...
                      <p
                        className={`text-xs mt-1 ${isDark ? 'text-neutral-400' : 'text-neutral-600'}`}
                      >
                        {fileData.progress}%
                      </p>
                    </div>
