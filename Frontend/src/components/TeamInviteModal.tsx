                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setSingleInvite({ ...singleInvite, email: e.target.value })
                                        }
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) =>
                                            setSingleInvite({ ...singleInvite, roleId: value })
                                        }
                                    >
                                ...
                                {jsonValidation && (
                                    <div className="p-4 border rounded-lg bg-muted/50">
                                        ...
                                        <div className="grid grid-cols-3 gap-4 text-sm">
                                            <div>
                                                <span className="text-green-600 font-medium">{jsonValidation.valid}</span> valid
                                            </div>
                                            <div>
                                                <span className="text-red-600 font-medium">{jsonValidation.invalid}</span> invalid
                                            </div>
                                            <div>
