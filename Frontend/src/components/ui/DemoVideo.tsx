    ...
    const initPlayer = () => {
      if (videoRef.current && !playerRef.current) {
        playerRef.current = videojs(videoRef.current, {
          ...
          responsive: true,
          poster:
            'https://fra.cloud.appwrite.io/v1/storage/buckets/697b974d001a7a80496e/files/697b9aea0008a7865980/view?project=69735edc00127d2033d8&mode=admin',
          ...
          <>
            ...
            >
              ...
              <p>
                ...
                <a href="https://fairarena.blob.core.windows.net/fairarena/Dashboard%20Preview%20Video">
                  link to the video
                </a>{' '}
                instead.
              </p>
            ...
            {!isPlaying && (
              <div className="absolute inset-0 flex items-center justify-center">
                <button
                  onClick={togglePlay}
                  className={cn(
                    'bg-[#d9ff00] text-black rounded-full p-4 hover:bg-[#c4e600] transition-colors',
                  )}
                >
          ...
          <div className="w-full h-64 md:h-96 flex items-center justify-center bg-linear-to-br from-primary/20 to-primary/10 rounded-2xl">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Video loading disabled in data saver mode
              </p>
            </div>
          </div>
        )}
