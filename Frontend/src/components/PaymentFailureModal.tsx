  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md mx-auto max-h-[90vh] overflow-y-auto bg-linear-to-br from-gray-900 via-gray-850 to-gray-900 border border-red-500/30 shadow-2xl backdrop-blur-xl">
        ...
        {/* Main content */}
        <div
          className={`relative z-10 transition-all duration-700 ease-out ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
        >
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white mb-3 tracking-tight">Payment Failed</h2>
              ...
              <div className="bg-linear-to-br from-red-500/15 to-red-600/10 border border-red-500/30 rounded-xl p-4 shadow-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-red-300 font-semibold text-sm mb-1.5">Error Details</p>
