    ...
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-3 text-sm text-muted-foreground">
                <strong>Purpose:</strong> Authentication, security, website functionality
                <br />
          ...
          <Card>
              ...
              <div className="flex items-center justify-between">
                ...
                <UICheckbox
                  ...
                  onCheckedChange={(checked: boolean | 'indeterminate') =>
                    updateSetting('analytics', checked === true)
                  }
                />
              </div>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-3 text-sm text-muted-foreground">
                <strong>Services:</strong> Microsoft Clarity, Google Analytics, Firebase Analytics
                <br />
          ...
          <Card>
            ...
            <CardContent>
              <CardDescription>
                These cookies enable enhanced functionality and personalization. They allow the
                website to remember choices you make (such as your username, language, or the region
                you are in) and provide enhanced, more personal features. These cookies are required
                for the website to function properly.
              </CardDescription>
              <div className="mt-3 text-sm text-muted-foreground">
                <strong>Services:</strong> Theme preferences, language settings, user interface
                customization
                <br />
          ...
          <Card>
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                ...
                <UICheckbox
                  ...
                  onCheckedChange={(checked: boolean | 'indeterminate') =>
                    updateSetting('marketing', checked === true)
                  }
                />
              </div>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-3 text-sm text-muted-foreground">
                <strong>Services:</strong> Advertising networks, social media pixels
                <br />
                <strong>Purpose:</strong> Targeted advertising and campaign measurement
                <br />
                <strong>Duration:</strong> Up to 2 years
                <br />
                <strong>Legal basis:</strong> Consent
        ...
        <div className="text-center text-sm text-muted-foreground mt-4">
          By clicking "Accept All", you consent to the use of cookies for all purposes described
          above. You can change your preferences at any time by visiting our{' '}
