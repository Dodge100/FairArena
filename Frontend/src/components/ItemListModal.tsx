...
import { AlertCircle, Bug, ChevronDown, ChevronUp, HelpCircle, Lightbulb, Loader2, MessageSquare, Sparkles } from 'lucide-react';
                                ...
                                return (
                                    <div key={item.id} className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                                        ...
                                        <div className="flex items-start justify-between gap-3 mb-3">
                                            ...
                                            <Badge variant={statusVariants[item.status] || 'secondary'} className="shrink-0">
                                        ...
                                        {(item.type || item.severity) && (
                                            <div className="flex flex-wrap gap-2 mb-3">
                                                ...
                                                {item.severity && (
                                                    <Badge variant={getSeverityVariant(item.severity)} className="flex items-center gap-1.5">
