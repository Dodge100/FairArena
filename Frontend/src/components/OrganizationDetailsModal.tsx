                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-1">
                                                <UserCheck className={`h-4 w-4 ${organization.joinEnabled ? 'text-green-600' : 'text-red-600'}`} />
                                                <span className="text-sm">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-sm font-medium">{formatDate(organization.createdAt)}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div>
                                            <h4 className="text-xs font-medium text-muted-foreground mb-1">Organization</h4>
                                            <div className="grid grid-cols-2 gap-1">
                                                {organization.userRole.permissions.organization && Object.entries(organization.userRole.permissions.organization).map(([key, value]) => (
                                                    <div key={`org-${key}`} className="flex items-center justify-between text-xs">
                                                        <span className="capitalize">{key.replace(/([A-Z])/g, ' $1').toLowerCase()}</span>
                                                        <Badge variant={value ? 'default' : 'secondary'} className="text-xs h-5">
                                                            {value ? '✓' : '✗'}
                                                        </Badge>
                                                    </div>
                                                ))}
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-2 gap-1">
                                                {organization.userRole.permissions.teams && Object.entries(organization.userRole.permissions.teams).map(([key, value]) => (
                                                    <div key={`team-${key}`} className="flex items-center justify-between text-xs">
                                                        <span className="capitalize">{key.replace(/([A-Z])/g, ' $1').toLowerCase()}</span>
                                                        <Badge variant={value ? 'default' : 'secondary'} className="text-xs h-5">
                                                            {value ? '✓' : '✗'}
                                                        </Badge>
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-2 gap-1">
                                                {organization.userRole.permissions.members && Object.entries(organization.userRole.permissions.members).map(([key, value]) => (
                                                    <div key={`member-${key}`} className="flex items-center justify-between text-xs">
                                                        <span className="capitalize">{key.replace(/([A-Z])/g, ' $1').toLowerCase()}</span>
                                                        <Badge variant={value ? 'default' : 'secondary'} className="text-xs h-5">
                                                            {value ? '✓' : '✗'}
                                                        </Badge>
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-2 gap-1">
                                                {organization.userRole.permissions.projects && Object.entries(organization.userRole.permissions.projects).map(([key, value]) => (
                                                    <div key={`project-${key}`} className="flex items-center justify-between text-xs">
                                                        <span className="capitalize">{key.replace(/([A-Z])/g, ' $1').toLowerCase()}</span>
                                                        <Badge variant={value ? 'default' : 'secondary'} className="text-xs h-5">
                                                            {value ? '✓' : '✗'}
                                                        </Badge>
