import { Check, ChevronsUpDown, LogOut, Plus, QrCode } from 'lucide-react';
...
export function AccountSwitcher() {
  ...
  const { user, accounts, activeSessionId, logout, logoutAllAccounts, switchAccount, maxAccounts } =
    useAuth();
            ...
            <DropdownMenuGroup>
              {uniqueAccounts.map((account) => (
                ...
                >
                  ...
                  {account.sessionId === activeSessionId && <Check className="ml-auto size-4" />}
                </DropdownMenuItem>
              ))}
            </DropdownMenuGroup>
