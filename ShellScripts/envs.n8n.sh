...
PROJECT="n8n"           # Doppler project slug
CONFIG="production-azure"                 # doppler config: dev/stg/prod etc.
ENV_FILE=".env.n8n"               # target env file
DOPPLER_TOKEN_FILE=".doppler_n8n_token"
