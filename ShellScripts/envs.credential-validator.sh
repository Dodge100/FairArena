...
CONFIG="production-credential-validator"                 # doppler config: dev/stg/prod etc.
ENV_FILE=".env.credential-validator"               # target env file
DOPPLER_TOKEN_FILE=".doppler_credential-validator_token"
